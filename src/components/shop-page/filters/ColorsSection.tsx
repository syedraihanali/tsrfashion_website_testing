        ...
        <AccordionContent className="pt-4 pb-0">
          <div className="flex space-2.5 flex-wrap md:grid grid-cols-5 gap-2.5">
            {colors.map((color) => {
              ...
              const checkmarkClass = isLightColor ? "text-black" : "text-white";
              const style: CSSProperties | undefined =
                color.style ?? (!color.className ? { backgroundColor: color.value } : undefined);
              ...
              return (
                <button
                  ...
                  className={cn([
                    ...
                    color.className,
                    !color.className && !style && "bg-black",
