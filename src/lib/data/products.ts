...
export const topSellingData: Product[] = [
  ...
  {
    id: 10,
    title: "Satin Statement Shirt",
    srcUrl: "/images/pic10.png",
    gallery: ["/images/pic10.png", "/images/pic11.png"],
    price: 140,
    discount: {
      amount: 0,
      percentage: 15,
...
export const productStyles = Array.from(
  new Set(allProducts.map((product) => product.style))
);
